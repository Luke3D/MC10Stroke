...
% for i = 1:2
%     tempConf = RealConfMat(i,:);
%     tempConf = tempConf(~cellfun('isempty',tempConf));
%     ind = length(tempConf);
%     
%     for j = 1:ind
%         temp = tempConf{j};
...
%         tempRec(isnan(tempRec)) = 0;
%         
%         Precision = [Precision tempPre];
%         Recall = [Recall tempRec]; 
%     end
%     
%     if i == 1
...
%         Recall_h = Recall;
%         
%         Precision_h_avg = mean(Precision, 2);
%         Recall_h_avg = mean(Recall, 2);
%         
%         Precision = [];
%         Recall = [];
%     else
%         Precision_g = Precision;
%         Recall_g = Recall;
%         
%         Precision_g_avg = mean(Precision,2);
%         Recall_g_avg = mean(Recall,2);
%         
%         Precision = [];
%         Recall = [];
%     end
