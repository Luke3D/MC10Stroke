...
emg_index=6-mod(get(handles.popupmenuLocation,'value'),2);

[filename,pathname] = uigetfile(['Z:\Stroke MC10\SCI\EMGtoLabel\*.csv']);
if filename == 0
    return;
end
...
if ~exist(['Z:\Stroke MC10\SCI\LabeledEMG\',handles.pathname(31:end)],'dir')
    mkdir(['Z:\Stroke MC10\SCI\LabeledEMG\',handles.pathname(31:end)])
end
